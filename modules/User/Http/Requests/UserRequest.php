...
class UserRequest extends BaseRequest
{
    ...
    protected $rules = [
        ...
        "updated_at"     => "date",
        "deleted_at"     => "date",
        "remember_token" => "string|between:0,255",
        //@rules
    ];
    ...
    protected $messages = [
        //@messages
        'id.integer' => '用户表id 必须是整数',
        'id.gt'      => '用户表id 必须大于0',
        'id.gte'     => '用户表id 必须大于等于0',
        'id.max'     => '用户表id 超出最大值',
        'id.min'     => '用户表id 超出最小值',
        'id.in'      => '用户表id 数值超出许可范围',
        'id.between' => '用户表id 最大长度是 20',

        'wx_openid.string'     => '微信openid 包含非法字符-只能是字符串',
        'wx_openid.alpha'      => '微信openid 包含非法字符-只能是/字母',
        'wx_openid.alpha_num'  => '微信openid 包含非法字符-只能是/字母/数字',
        'wx_openid.alpha_dash' => '微信openid 包含非法字符',
        'wx_openid.between'    => '微信openid 最大长度是 255',

        'qq_openid.string'     => 'qq openid 包含非法字符-只能是字符串',
        'qq_openid.alpha'      => 'qq openid 包含非法字符-只能是/字母',
        'qq_openid.alpha_num'  => 'qq openid 包含非法字符-只能是/字母/数字',
        'qq_openid.alpha_dash' => 'qq openid 包含非法字符',
        'qq_openid.between'    => 'qq openid 最大长度是 255',

        'role.string'     => '用户角色(user,admin) 包含非法字符-只能是字符串',
        'role.alpha'      => '用户角色(user,admin) 包含非法字符-只能是/字母',
        'role.alpha_num'  => '用户角色(user,admin) 包含非法字符-只能是/字母/数字',
        'role.alpha_dash' => '用户角色(user,admin) 包含非法字符',
        'role.between'    => '用户角色(user,admin) 最大长度是 255',

        'name.string'     => '姓名 包含非法字符-只能是字符串',
        'name.alpha'      => '姓名 包含非法字符-只能是/字母',
        'name.alpha_num'  => '姓名 包含非法字符-只能是/字母/数字',
        'name.alpha_dash' => '姓名 包含非法字符',
        'name.between'    => '姓名 最大长度是 255',

        'nickname.string'     => '昵称 包含非法字符-只能是字符串',
        'nickname.alpha'      => '昵称 包含非法字符-只能是/字母',
        'nickname.alpha_num'  => '昵称 包含非法字符-只能是/字母/数字',
        'nickname.alpha_dash' => '昵称 包含非法字符',
        'nickname.between'    => '昵称 最大长度是 255',

        'avatar.string'     => '头像 包含非法字符-只能是字符串',
        'avatar.alpha'      => '头像 包含非法字符-只能是/字母',
        'avatar.alpha_num'  => '头像 包含非法字符-只能是/字母/数字',
        'avatar.alpha_dash' => '头像 包含非法字符',
        'avatar.between'    => '头像 最大长度是 255',
        ...
        'im_password.string'     => 'im号密码 包含非法字符-只能是字符串',
        'im_password.alpha'      => 'im号密码 包含非法字符-只能是/字母',
        'im_password.alpha_num'  => 'im号密码 包含非法字符-只能是/字母/数字',
        'im_password.alpha_dash' => 'im号密码 包含非法字符',
        'im_password.between'    => 'im号密码 最大长度是 255',
        ...
        'client_driver.required'   => '客户端信息 不能为空',
        ...
        'remember_token.string'     => 'auth remember_token 包含非法字符-只能是字符串',
        'remember_token.alpha'      => 'auth remember_token 包含非法字符-只能是/字母',
        'remember_token.alpha_num'  => 'auth remember_token 包含非法字符-只能是/字母/数字',
        'remember_token.alpha_dash' => 'auth remember_token 包含非法字符',
        'remember_token.between'    => 'auth remember_token 最大长度是 255',
