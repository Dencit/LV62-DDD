...
class OauthClientRequest extends BaseRequest
{
    ...
    protected $rules = [
		...
		"client_title"=>"string|between:0,255",
		"client_info"=>"string|between:0,255",
		"client_id"=>"string|between:0,255",
		"client_secret"=>"string|between:0,255",
		"type"=>"integer|in:1,2",
    ...
    protected $messages = [
		...
		'client_title.string'=>'授权客户端-名称 包含非法字符-只能是字符串',
		'client_title.alpha'=>'授权客户端-名称 包含非法字符-只能是/字母',
		'client_title.alpha_num'=>'授权客户端-名称 包含非法字符-只能是/字母/数字',
		'client_title.alpha_dash'=>'授权客户端-名称 包含非法字符',
		'client_title.between'=>'授权客户端-名称 最大长度是 255',
		
		'client_info.string'=>'授权客户端-描述 包含非法字符-只能是字符串',
		'client_info.alpha'=>'授权客户端-描述 包含非法字符-只能是/字母',
		'client_info.alpha_num'=>'授权客户端-描述 包含非法字符-只能是/字母/数字',
		'client_info.alpha_dash'=>'授权客户端-描述 包含非法字符',
		'client_info.between'=>'授权客户端-描述 最大长度是 255',
		
		'client_id.string'=>'授权客户端-标记 包含非法字符-只能是字符串',
		'client_id.alpha'=>'授权客户端-标记 包含非法字符-只能是/字母',
		'client_id.alpha_num'=>'授权客户端-标记 包含非法字符-只能是/字母/数字',
		'client_id.alpha_dash'=>'授权客户端-标记 包含非法字符',
		'client_id.between'=>'授权客户端-标记 最大长度是 255',
		
		'client_secret.string'=>'授权客户端-密匙 包含非法字符-只能是字符串',
		'client_secret.alpha'=>'授权客户端-密匙 包含非法字符-只能是/字母',
		'client_secret.alpha_num'=>'授权客户端-密匙 包含非法字符-只能是/字母/数字',
		'client_secret.alpha_dash'=>'授权客户端-密匙 包含非法字符',
		'client_secret.between'=>'授权客户端-密匙 最大长度是 255',
